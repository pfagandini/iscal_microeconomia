...
## Curto Prazo vs. Longo Prazo {.smaller}
...
## Taxa Marginal de Substituição Técnica (TMST) {.smaller}
...
ggplot() +
  ...
  geom_point(aes(x=3.2, y=iq_fun(3.2)), size=2.5, colour="#2980b9") +
  ...
  annotate("text", x=2.6, y=8.5, label="a", size=3.5, colour="#2980b9") +
...
ggplot() +
  ...
  annotate("text", x=6, y=1.5, label="LP: CT*\n(óptimo)", colour="#27ae60", size=3.2) +
  annotate("text", x=8, y=4.8, label="CP: CT > CT*", colour="#c0392b", size=3.2) +
...
## Custos Económicos vs. Contabilísticos {.smaller}
