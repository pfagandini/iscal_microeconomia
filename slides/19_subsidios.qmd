...
ggplot() +
  ...
  # Shading XP
  geom_polygon(aes(x = c(0, 75, 75), y = c(0, 0, 25)),
  ...
  # Labels
  annotate("text", x = 20, y = 60, label = "XC", size = 5, color = "steelblue") +
  annotate("text", x = 20, y = 10, label = "XP", size = 5, color = "tomato") +
...
Verificação:
$$\text{DF} = 825; \quad \Delta XC = 590{,}6; \quad \Delta XP = 196{,}9$$
...
- $\Delta XC = \frac{65 \times 130}{2} - \frac{56 \times 112}{2} = 4225 - 3136 = 1089$ u.m.
- $\Delta XP = 1950 - 1089 - 135 = 726$ u.m.
- $\text{DF} - \Delta XC - \Delta XP = 1950 - 1089 - 726 = 135$ u.m. ✓
...
|---|---|---|---|
| $XC = \frac{(100-P_D)\cdot Q}{2}$ | 1800 | 2178 | $+378$ |
| $XP = \frac{(P_S - 10)\cdot Q}{2}$ | 900 | 1089 | $+189$ |
| $\text{DF}$ | — | 594 | — |
| PP $= \text{DF} - \Delta XC - \Delta XP$ | — | — | $594 - 378 - 189 = 27$ ✓ |
:::
