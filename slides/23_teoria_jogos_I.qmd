...
**1. Análise do Jogador A:**
- Se B joga $s_{B1}$: $3 > 1 \Rightarrow s_{A1}$ é melhor.
- Se B joga $s_{B2}$: $4 > 2 \Rightarrow s_{A1}$ é melhor.
- $\therefore s_{A1}$ **domina estritamente** $s_{A2}$. O Jogador A eliminará $s_{A2}$.

. . .

**2. Análise do Jogador B (após a eliminação de $s_{A2}$):**
- Sabendo que A jogará $s_{A1}$, o Jogador B compara os seus payoffs na primeira linha: $2 > 1$.
- $\therefore s_{B1}$ é a melhor resposta ao jogar $s_{A1}$.
