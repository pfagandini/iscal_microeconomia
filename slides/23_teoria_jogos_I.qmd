...
```{r, engine='tikz', engine.opts=list(extra.preamble="\\usetikzlibrary{matrix}")}
...
\begin{tikzpicture}[every node/.style={scale=0.82}]
  ...
  \node at (2.1, 1.2) {\textit{Calar}};
  \node at (3.8, 1.2) {\textit{Confessar}};
  \node[rotate=90] at (0.3, 0) {\textbf{Suspeito A}};
  \node[rotate=90] at (0.55,  0.4) {\textit{Calar}};
  \node[rotate=90] at (0.55, -0.8) {\textit{Confessar}};
...
\begin{tikzpicture}[every node/.style={scale=0.82}]
  ...
  \node at (2.0, 1.2) {\textit{Cooperar}};
  \node at (3.9, 1.2) {\textit{Delatar}};
  \node[rotate=90] at (0.3, 0) {\textbf{Empresa A}};
  \node[rotate=90] at (0.6,  0.4) {\textit{Cooperar}};
  \node[rotate=90] at (0.6, -0.8) {\textit{Delatar}};
...
```{r, engine='tikz'}
\begin{tikzpicture}[every node/.style={scale=0.82}]
  \node at (2.7, 1.6) {\textbf{Jogador B}};
  \node at (2.1, 1.2) {\textit{Esquerda}};
  \node at (3.9, 1.2) {\textit{Direita}};
  \node[rotate=90] at (0.4, 0) {\textbf{Jogador A}};
  \node[rotate=90] at (0.7,  0.4) {\textit{Esquerda}};
  \node[rotate=90] at (0.7, -0.8) {\textit{Direita}};
...
```{r, engine='tikz'}
\begin{tikzpicture}[every node/.style={scale=0.85}]
  \node at (2.5, 1.5) {\textbf{Empresa B}};
  \node at (2.0, 1.15) {\textit{Alto}};
  \node at (3.8, 1.15) {\textit{Baixo}};
  \node[rotate=90] at (0.3, 0) {\textbf{Empresa A}};
  \node[rotate=90] at (0.55,  0.4) {\textit{Alto}};
  \node[rotate=90] at (0.55, -0.8) {\textit{Baixo}};
  \node at (2.0,  0.5) {$(3,\ 3)$};
  \node at (3.8,  0.5) {$(1,\ 5)$};
  \node at (2.0, -0.7) {$(5,\ 1)$};
  \node at (3.8, -0.7) {$(2,\ 2)$};
...
\begin{tikzpicture}[every node/.style={scale=0.85}]
  ...
  \node[rotate=90] at (0, 0) {\textbf{Empresa A}};
  \node[rotate=90] at (0.6,  0.4) {\textit{Cooperar}};
  \node[rotate=90] at (0.6, -0.8) {\textit{Delatar}};
  \node at (2.0,  0.5) {$(6,\ 6)$};
  \node at (3.9,  0.5) {$(0,\ 8)$};
