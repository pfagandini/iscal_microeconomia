...
## Revisão: A Escolha Óptima do Produtor{.smaller}
...
## Decisão de Encerramento: a lógica {.smaller}
...
p2 <- make_plot_active(0.75, "Prejuízo, mas produz\n(CVM ≤ p < CTM)", "#e67e22", c(2.5, 7))
...
## Limiar de Encerramento: geometria {.smaller}
...
## A Curva de Oferta Individual {.smaller}
...
## Excedente do Produtor: definição {.smaller}
...
## Excedente do Produtor vs Lucro {.smaller}
