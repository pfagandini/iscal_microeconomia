...
## A Lógica do Undercutting {.smaller}
...
## O Factor de Desconto $\delta$ {.smaller}
...
## Condição de Sustentabilidade da Colusão {.smaller}
...
## Derivação do $\delta$ Mínimo {.smaller}
...
## Quando é a Colusão Mais Provável? {.smaller}
