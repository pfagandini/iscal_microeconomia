...
## Revisão: Etapas do Processo Produtivo {.center}
...
## Exemplo Numérico — Tabela Completa {.smaller}
...
% VMPL = P*MPL
\draw[blue, thick, domain=1:7.5, variable=\x, samples=60]
...
::: {.fragment}
**Etapa I → II** ($MPL = APL$):
$$-3L^2 + 24L + 60 = -L^2 + 12L + 60 \implies -2L^2 + 12L = 0 $$
$$\implies L(L-6)=0\implies L_1 = 6$$
:::
